...
class CardController extends Controller
{
    ...
    {
        $response = $this->get_all_cards_action->apply(User::find(Auth::user()));
    ...
    public function add()
    {
        $response = $this->add_card_action->apply(User::find(Auth::user()));
    ...
    {
        $response = $this->delete_card_action->apply(User::find(Auth::user()), $card_id);
